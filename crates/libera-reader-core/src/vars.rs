...
use crate::models::{Settings, TargetExt};
...
pub(crate) static NOTIFY_EVENTS: Lazy<ConcurrentQueue<NotifyEvents>> =
...
pub static NOT_CACHED_BOOKS: Lazy<RwLock<Vec<Box<NotCachedBook>>>> =
